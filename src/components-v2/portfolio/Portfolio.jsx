          ...
          <div className="antiscroll-wrap">
            ...
            <div className="antiscroll-inner">
              ...
              <div className="content">
                ...
                {/*FILTERS*/}
                <ul id="filters">
                  <li className="current"><a href="#" data-filter="*">ALL</a></li>
                ...
                <div className="portfolio-items">
                  ...
                  <div className="coding video hentry">
                    <div className="media-box">
                      ...
                      <div className="mask">
                        {/* lightbox - video */}
                        <a href="http://player.vimeo.com/video/37254322?badge=0&color=ffffff" title="Paper by FiftyThree" data-lightbox-gallery="fancybox-item-03" className="lightbox iframe" />
                        {/* lightbox - video */}
                      </div>
                    </div>
                  ...
                  <div className="design image hentry">
                    <div className="media-box">
                      ...
                      <div className="mask">
                        {/* lightbox - image */}
                        <a href="images/portfolio/lightbox-01.jpg" title="Animal with love" data-lightbox-gallery="fancybox-item-01" className="lightbox" />
                        {/* lightbox - image */}
                      </div>
                    </div>
                  ...
                  <div className="coding audio hentry">
                    <div className="media-box">
                      ...
                      <div className="mask">
                        {/* lightbox - soundcloud */}
                        <a href="http://w.soundcloud.com/player/?url=http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F207988&" title="Soundcloud embed" data-lightbox-gallery="fancybox-item-04" className="lightbox iframe" />
                        {/* lightbox - soundcloud */}
                      </div>
                    </div>
                    <h4>Volume 2</h4>
                  ...
                  <div className="logo image hentry">
                    <div className="media-box">
                      ...
                      <div className="mask">
                        {/* lightbox - gallery */}
                        <a href="images/portfolio/lightbox-02.jpg" data-lightbox-gallery="fancybox-item-02" className="lightbox" title="Octopus is dangerous!" />
                        <a href="images/portfolio/lightbox-04.jpg" data-lightbox-gallery="fancybox-item-02" className="hidden lightbox" />
                        <a href="images/portfolio/lightbox-03.jpg" data-lightbox-gallery="fancybox-item-02" className="hidden lightbox" title="Dog have dreams" />
                        {/* lightbox - gallery */}
                      </div>
                    </div>
                  ...
                  <div className="logo url hentry">
                    <div className="media-box">
                      ...
                      <div className="mask">
                        <a href="http://themeforest.net/user/pixelwars" target="_blank" />
                      </div>
                    </div>
